...
export default function Dashboard() {
  ...
  const handlePublish = async () => {
    try {
      ...
      // Fetch ki jagah api.post ka use kiya
      // Axios automatically Content-Type ko multipart/form-data set kar deta hai
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      {/* Stats Section same as yours... */}
      <div className="grid md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white shadow rounded-xl p-4"><h3>Total Articles</h3><p className="text-3xl font-bold">0</p></div>
        <div className="bg-white shadow rounded-xl p-4"><h3>Published</h3><p className="text-3xl font-bold">0</p></div>
        <div className="bg-white shadow rounded-xl p-4"><h3>Drafts</h3><p className="text-3xl font-bold">0</p></div>
        <div className="bg-white shadow rounded-xl p-4"><h3>Subscribers</h3><p className="text-3xl font-bold">0</p></div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow p-6">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button onClick={handlePublish} className="bg-blue-600 text-white px-5 py-3 rounded">
